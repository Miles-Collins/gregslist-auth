...
export function getHouseForm(house = new House({})) {
  ...
  <div class="row">
    <div class="col-4">
      ...
      <input class="form-control" type="text" minlength="1" id="bedrooms" name="bedrooms" value="${house.bedrooms}" >
    </div>
    <div class="col-4">
    ...
    <div class="col-4">
      ...
      <input class="form-control" type="number" id="year" name="year" min="1969" value="${house.year}">
    </div>
    <div class="col-4">
      <label class="form-label" for="year">Levels</label>
      <input class="form-control" type="number" id="levels" name="levels" min="1" value="${house.levels}">
     </div> 
    <label class="form-label" for="price">Price</label>
    <input class="form-control" type="number" min="100000" id="price" name="price" value="${house.price}">
